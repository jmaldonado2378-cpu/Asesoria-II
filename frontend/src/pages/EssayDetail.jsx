            ...
            const results = await Promise.all(images.map(async (img) => {
                try {
                    const url = img.image?.startsWith('http')
                        ? img.image
                        : `https://uhoudbwppwctcddabdmo.supabase.co/storage/v1/object/public/${img.image}`;
