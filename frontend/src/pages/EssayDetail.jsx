            ...
            <div>
                ...
                <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-sm overflow-hidden border border-slate-300">
                    ...
                    <div className="p-8 space-y-10">
                        ...
                        <section className="print:break-inside-avoid print:mt-6"><h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider border-b border-slate-200 pb-2 mb-4 flex items-center gap-2"><ClipboardCheck size={16} /> Evaluación de Calidad</h3>
                            <div className="bg-white border border-slate-200 rounded-sm p-6 grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-x-12 gap-y-2">
